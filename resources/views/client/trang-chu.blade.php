...
.tab-phim-item.active {
    ...
    <div class="list">
        <p>
        <a href="#" class="tab-phim-item active" data-tab="dang-chieu">Đang chiếu</a></p>
       <p>
...
document.querySelectorAll('.menu .list a.tab-phim-item').forEach(tab => {
    ...
    btn.addEventListener('click', function() {
        ...
        document.getElementById('overlayBg').style.display = 'block';
                    ...
                    // Cập nhật active tab
                    document.querySelectorAll('.menu .list a.tab-phim-item').forEach(t => t.classList.remove('active'));
