                        ...
                        <div class="movie-info">
                            ...
                            <div class="movie-details">
                                ...
                                <div class="movie-meta">
                                    <span class="format-badge">{{ $ve->suatChieu->formatted_version }}</span>
                    ...
                    <div class="ticket-details-grid">
                        <div class="detail-card">
                            ...
                            <div class="detail-content">
                                ...
                                <span
                                    class="detail-value">{{ \Carbon\Carbon::parse($ve->suatChieu->ngay_bat_dau)->format('d/m/Y') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="detail-card">
                            ...
                            <div class="detail-content">
                                ...
                                <span
                                    class="detail-value">{{ \Carbon\Carbon::parse($ve->suatChieu->bat_dau)->format('H:i') }}
                                    - {{ \Carbon\Carbon::parse($ve->suatChieu->ket_thuc)->format('H:i') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="detail-card">
                            ...
                            <div class="detail-content">
                                ...
                                <span
                                    class="detail-value">{{ $ve->suatChieu->phongChieu->rapPhim->chiNhanh->ten_chi_nhanh }}</span>
                                <span
                                    class="detail-sub">{{ $ve->suatChieu->phongChieu->rapPhim->chiNhanh->dia_chi }}</span>
                            </div>
                        </div>
                                        ...
                                        @foreach ($ve->combos as $combo)
                                            <div class="food-item">
                                                ...
                                                <div class="food-info">
                                                    ...
                                                    <span class="food-quantity">Số lượng:
                                                        {{ $combo->pivot->so_luong }}</span>
                                                </div>
