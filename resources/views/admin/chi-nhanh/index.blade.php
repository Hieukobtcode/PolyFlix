                ...
                <div class="row mb-4 g-2 align-items-center">
                    ...
                    <div style="display: none" class="col-md-3">
                        <select id="statusFilter" class="form-select">
                            <option value="" {{ request('statusFilter') === null ? 'selected' : '' }} disabled hidden>
                                Trạng thái</option>
                ...
                <div class="table-responsive">
                    <table class="table text-nowrap align-middle mb-0">
                        ...
                        <tbody id="chiNhanhTable">
                            ...
                            <tr class="data-row" data-state-ql="@if ($chiNhanh->quan_ly_id) da_phan_cong
                                        @elseif (in_array($chiNhanh->id, $pendingInvites)) dang_phan_cong
                                        @else chua_phan_cong @endif" data-state-cn="{{ $chiNhanh->trang_thai }}"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between px-3 pb-3">
                    <button class="btn btn-light btn-sm rounded-pill px-4" data-bs-dismiss="modal">Đóng</button>
                    <form action="{{ route('admin.invite.cancel') }}" method="POST"
                        ...
                        <button type="submit" class="btn bg-warning-subtle text-warning btn-sm rounded-pill px-4">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-md">
            <form method="POST" action="{{ route('invite.send') }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between px-3 pb-3">
                        <button type="button" class="btn btn-light btn-sm rounded-pill px-4" data-bs-dismiss="modal">
                            Hủy
                        </button>
                        <button type="submit" class="btn bg-success-subtle text-success btn-sm rounded-pill px-4">
