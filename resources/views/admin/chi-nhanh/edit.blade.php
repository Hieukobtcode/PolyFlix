                ...
                <form action="{{ route('admin.chi-nhanh.update', $chiNhanh->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('ten_chi_nhanh') is-invalid @enderror"
                            id="ten_chi_nhanh" name="ten_chi_nhanh"
                            value="{{ old('ten_chi_nhanh', $chiNhanh->ten_chi_nhanh) }}" placeholder="Nhập tên chi nhánh">
                        @error('ten_chi_nhanh')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control @error('quan_ly_id') is-invalid @enderror" id="quan_ly_id"
                            name="quan_ly_id" value="{{ old('quan_ly_id', $chiNhanh->quan_ly_id) }}"
