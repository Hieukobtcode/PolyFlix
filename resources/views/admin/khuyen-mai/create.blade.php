...
@section('breadcrumb', 'Thêm khuyến mãi mới')
        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0 fw-bold">Thêm khuyến mãi mới</h5>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ma_khuyen_mai') is-invalid @enderror" 
                                        id="ma_khuyen_mai" name="ma_khuyen_mai" value="{{ old('ma_khuyen_mai') }}" required>
                                    @error('ma_khuyen_mai')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('loai_giam_gia') is-invalid @enderror" 
                                        ...
                                        <option value="tien" {{ old('loai_giam_gia') == 'tien' ? 'selected' : '' }}>Tiền (VNĐ)</option>
                                    </select>
                                    @error('loai_giam_gia')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('gia_tri_giam') is-invalid @enderror" 
                                        id="gia_tri_giam" name="gia_tri_giam" value="{{ old('gia_tri_giam') }}" min="0" step="0.01" required>
                                    @error('gia_tri_giam')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('giam_toi_da') is-invalid @enderror" 
                                        id="giam_toi_da" name="giam_toi_da" value="{{ old('giam_toi_da') }}" min="0" step="0.01">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('ap_dung_cho') is-invalid @enderror" 
                                        ...
                                        <option value="do_an" {{ old('ap_dung_cho') == 'do_an' ? 'selected' : '' }}>Đồ ăn</option>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('don_toi_thieu') is-invalid @enderror" 
                                        id="don_toi_thieu" name="don_toi_thieu" value="{{ old('don_toi_thieu') }}" min="0" step="0.01">
                                    @error('don_toi_thieu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('so_lan_su_dung_toi_da') is-invalid @enderror" 
                                        id="so_lan_su_dung_toi_da" name="so_lan_su_dung_toi_da" value="{{ old('so_lan_su_dung_toi_da') }}" min="1">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('ngay_ket_thuc') is-invalid @enderror" 
                                        id="ngay_ket_thuc" name="ngay_ket_thuc" value="{{ old('ngay_ket_thuc') }}" required>
                                    @error('ngay_ket_thuc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select select2 @error('chi_nhanh_ids') is-invalid @enderror" 
                                ...
                                @foreach($chiNhanhs as $chiNhanh)
                                    <option value="{{ $chiNhanh->id }}" {{ in_array($chiNhanh->id, old('chi_nhanh_ids', [])) ? 'selected' : '' }}>
