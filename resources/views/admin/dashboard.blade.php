                ...
                <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                  <div>
                    <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                        <svg class="icon">
                          <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-arrow-bottom') }}">
</use>
                        </svg>)</span></div>
                    <div>Users</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="progress-group mb-5">
                        <div class="progress-group-header">
                          <svg class="icon icon-lg me-2">
                            <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-user-female') }}">
</use>
                          </svg>
                          <div>Female</div>
                      ...
                      <div class="progress-group">
                        <div class="progress-group-header">
                          <svg class="icon icon-lg me-2">
                            <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/brand.svg#cib-google') }}">
</use>
                          </svg>
                    ...
                    <table class="table border mb-0">
                      <thead class="fw-semibold text-nowrap">
                        <tr class="align-middle">
                          <th class="bg-body-secondary text-center">
                            <svg class="icon">
                              <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-people') }}">
</use>
                            </svg>
                          </th>
                      ...
                      <tbody>
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard') }}">
</use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/brand.svg#cib-cc-visa') }}">
</use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe') }}">
</use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal') }}">
</use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay') }}">
</use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/brand.svg#cib-cc-amex') }}">
</use>
                            </svg>
                          </td>
                          <td>
