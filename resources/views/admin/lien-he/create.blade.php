                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('so_dien_thoai') is-invalid @enderror" id="so_dien_thoai" name="so_dien_thoai" value="{{ old('so_dien_thoai') }}" required>
                                                @error('so_dien_thoai')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('nguon_goc') is-invalid @enderror" id="nguon_goc" name="nguon_goc" value="{{ old('nguon_goc') }}" list="nguon_goc_list">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('noi_dung') is-invalid @enderror" id="noi_dung" name="noi_dung" rows="5" required>{{ old('noi_dung') }}</textarea>
                                        @error('noi_dung')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('ghi_chu_noi_bo') is-invalid @enderror" id="ghi_chu_noi_bo" name="ghi_chu_noi_bo" rows="3">{{ old('ghi_chu_noi_bo') }}</textarea>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('muc_do_uu_tien') is-invalid @enderror" id="muc_do_uu_tien" name="muc_do_uu_tien">
                                            <option value="cao" {{ old('muc_do_uu_tien') == 'cao' ? 'selected' : '' }}>Cao</option>
                                            <option value="binh_thuong" {{ old('muc_do_uu_tien') == 'binh_thuong' ? 'selected' : '' }} selected>Bình thường</option>
                                            <option value="thap" {{ old('muc_do_uu_tien') == 'thap' ? 'selected' : '' }}>Thấp</option>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('phan_loai') is-invalid @enderror" id="phan_loai" name="phan_loai" value="{{ old('phan_loai') }}" list="phan_loai_list">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('da_phan_hoi') is-invalid @enderror" id="da_phan_hoi" name="da_phan_hoi">
                                            <option value="0" {{ old('da_phan_hoi') == '0' ? 'selected' : '' }} selected>Chưa phản hồi</option>
                                            <option value="1" {{ old('da_phan_hoi') == '1' ? 'selected' : '' }}>Đã phản hồi</option>
                                        </select>
                                        @error('da_phan_hoi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nguoi_phu_trach') is-invalid @enderror" id="nguoi_phu_trach" name="nguoi_phu_trach" value="{{ old('nguoi_phu_trach') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('ngay_hen') is-invalid @enderror" id="ngay_hen" name="ngay_hen" value="{{ old('ngay_hen') }}">
                                        @error('ngay_hen')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
