        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                            @forelse($lienHes as $lienHe)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $lienHe->muc_do_uu_tien == 'cao' ? 'bg-danger' : ($lienHe->muc_do_uu_tien == 'thap' ? 'bg-info' : 'bg-secondary') }}">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div>
                        <small class="text-muted">Hiển thị {{ $lienHes->count() }} trong tổng số {{ $lienHes->total() }}
                            liên hệ</small>
                    </div>
                    <div>
