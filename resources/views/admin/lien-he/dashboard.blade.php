...
@section('title', 'Dashboard liên hệ')
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('admin.lien-he.index') }}" class="btn btn-outline-primary btn-sm">
                                        <svg class="icon me-2">
                                            <use
                                                xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-list') }}">
                                            </use>
            ...
            <div class="row mb-4">
                <div class="col-sm-6 col-xl-3">
                    <div class="card mb-4 text-white bg-primary">
                        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="fs-4 fw-semibold">{{ $stats['total'] }} <span class="fs-6 fw-normal"></span>
                                </div>
                            ...
                            <div class="dropdown">
                                <svg class="icon icon-xl">
                                    <use
                                        xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-address-book') }}">
                                    </use>
                                </svg>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card mb-4 text-white bg-warning">
                        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="fs-4 fw-semibold">{{ $stats['pending'] }} <span class="fs-6 fw-normal"></span>
                                </div>
                                <div>Chưa xử lý</div>
                            </div>
                            <div class="dropdown">
                                <svg class="icon icon-xl">
                                    <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-clock') }}">
                                    </use>
                                </svg>
                            </div>
                        </div>
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                            <a href="{{ route('admin.lien-he.index', ['status' => 0]) }}"
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card mb-4 text-white bg-success">
                        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="fs-4 fw-semibold">{{ $stats['completed'] }} <span class="fs-6 fw-normal"></span>
                                </div>
                                <div>Đã xử lý</div>
                            </div>
                            <div class="dropdown">
                                <svg class="icon icon-xl">
                                    <use
                                        xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-check-circle') }}">
                                    </use>
                                </svg>
                            </div>
                        </div>
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                            <a href="{{ route('admin.lien-he.index', ['status' => 1]) }}"
                                class="small-box-footer text-white">
                                Xem chi tiết <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card mb-4 text-white bg-danger">
                        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="fs-4 fw-semibold">{{ $stats['high_priority'] }} <span
                                        class="fs-6 fw-normal"></span></div>
                                <div>Ưu tiên cao</div>
                            </div>
                            <div class="dropdown">
                                <svg class="icon icon-xl">
                                    <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-flag-alt') }}">
                                    </use>
                                </svg>
                            </div>
                        </div>
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                            <a href="{{ route('admin.lien-he.index', ['priority' => 'cao']) }}"
                                class="small-box-footer text-white">
                                Xem chi tiết <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                                    ...
                                    <tbody>
                                        @forelse($highPriorityContacts as $lienHe)
                                            <tr>
                                                ...
                                                <td>{{ $lienHe->formatted_create_at }}</td>
                                                <td>
                                                    <form action="{{ route('admin.lien-he.update', $lienHe->id) }}"
                                                        method="POST" class="d-inline">
                                                        @csrf
                                                        @method('PUT')
                                                        <button type="submit"
                                                            class="btn btn-sm btn-{{ $lienHe->trang_thai ? 'warning' : 'success' }}">
                                                            <svg class="icon">
                                                                <use
                                                                    xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-check-circle') }}">
                                                                </use>
