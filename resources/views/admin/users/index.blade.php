                        ...
                        <tbody id="userTable">
                            @forelse($users as $index => $user)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : 'https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/profile/user-1.jpg' }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterTable() {
                ...
                rows.forEach(row => {
                    ...
                    const status = row.querySelector('td:nth-child(5)').getAttribute('data-status') || '';
                    const active = row.querySelector('td:nth-child(6)').textContent.trim().toLowerCase();
                    ...
                    const match =
                        ...
                        (activeFilter === '' ||
                            (activeFilter === '1' && active === 'online') ||
                            (activeFilter === '0' && active === 'offline'));
