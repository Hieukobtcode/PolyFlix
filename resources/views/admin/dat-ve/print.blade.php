...
<body>
    <!-- Vé xem phim (mỗi ghế một vé, mỗi vé một trang) -->
    @foreach ($datVe->gheNgois as $ghe)
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="center" style="padding:40px 0;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="ticket-container ticket-container-ve">
                        <tr>
                        ...
                        <tr>
                            <td class="barcode-section">
                                @if (!empty($barcodeFileName))
                                    <img src="{{ public_path('temp/' . $barcodeFileName) }}" alt="Mã vạch" class="barcode-img">
                                @else
                            ...
                            <td class="details-table">
                                <table width="100%" cellpadding="6">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">{{ $datVe->suatChieu?->phongChieu?->rapPhim?->ten_rap ?? 'Không rõ' }}</td>
                                    </tr>
                                    <tr>
                                        <td align="left"><strong>Chi nhánh</strong></td>
                                        <td align="right">{{ $datVe->suatChieu?->phongChieu?->rapPhim?->chiNhanh?->ten_chi_nhanh ?? 'Không rõ' }}</td>
                                    </tr>
                                    <tr>
                                        <td align="left"><strong>Phòng</strong></td>
                                        <td align="right">{{ $datVe->suatChieu?->phongChieu?->ten_phong ?? 'Không rõ' }}</td>
                                    </tr>
                                    <tr>
                                        <td align="left"><strong>Suất chiếu</strong></td>
                                        <td align="right">
                                            Ngày: {{ \Carbon\Carbon::parse($datVe->suatChieu?->ngay_bat_dau)->format('d/m/Y') ?? '' }}<br>
