...
@section('title', 'Chỉnh sửa cấp bậc thẻ')
@section('page-title', 'Chỉnh sửa cấp bậc thẻ')
@section('breadcrumb', 'Chỉnh sửa cấp bậc thẻ')
    ...
    <div class="container-fluid">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold">Chỉnh sửa cấp bậc thẻ: {{ $capBacThe->ten }}</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number"
                                        ...
                                        id="phan_tram_ve" name="phan_tram_ve"
