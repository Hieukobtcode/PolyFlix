                ...
                <form action="{{ route('admin.loai-phong.update', $loaiPhong->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ten_loai_phong"
                            ...
                            value="{{ old('ten_loai_phong', $loaiPhong->ten_loai_phong) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="mo_ta" class="form-control @error('mo_ta') is-invalid @enderror" rows="4">{{ old('mo_ta', $loaiPhong->mo_ta) }}</textarea>
                        @error('mo_ta')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
