...
@section('page-title', 'Thêm phụ đề phim')
@section('breadcrumb', 'Thêm phụ đề phim')
@section('styles')
    <style>
        .card {
            border-radius: 10px;
    ...
    <div class="container-fluid">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold">Thêm phụ đề phim mới</h5>
                <a href="{{ route('admin.phu-de-phim.index') }}" class="btn btn-light btn-sm">
                    <i class="fas fa-arrow-left me-1"></i> Quay lại
                </a>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('admin.phu-de-phim.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control rounded @error('ten_phu_de') is-invalid @enderror"
                                    id="ten_phu_de" name="ten_phu_de" value="{{ old('ten_phu_de') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select rounded @error('trang_thai') is-invalid @enderror"
                                    ...
                                    <option value="không hoạt động"
                                        {{ old('trang_thai') === 'không hoạt động' ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control rounded @error('mo_ta') is-invalid @enderror" id="mo_ta" name="mo_ta" rows="4"
                            placeholder="Nhập mô tả phụ đề">{{ old('mo_ta') }}</textarea>
                        @error('mo_ta')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('admin.phu-de-phim.index') }}" class="btn btn-outline-secondary">Hủy</a>
